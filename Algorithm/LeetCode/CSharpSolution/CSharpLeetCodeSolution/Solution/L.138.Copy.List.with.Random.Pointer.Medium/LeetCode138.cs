...
namespace Solution
{
    ...
    public class LeetCode138Node
    {
        public int Value;
        public LeetCode138Node Next;
        public LeetCode138Node Random;
    ...
    {
        private static Dictionary<LeetCode138Node, LeetCode138Node> tracker = new Dictionary<LeetCode138Node, LeetCode138Node>();
